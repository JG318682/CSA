...
public class Zoo
{
    public static  void main(String[] args) throws InterruptedException 
    {
        ...
        while(!text.equals("leave"))
        {
            ...
            {
                case "help" : 
                msg = "We can visit cages, listen, look up, look around, look down, " +
                        "go to concessions, go to gift shop, or leave \n"+
                "and ask for help.";
                break;
                case "visit cages" : 
                ...
                break;
                case "go to concessions":
                    Concessions.displayConcessions();
                    break;
                case "go to gift shop":
